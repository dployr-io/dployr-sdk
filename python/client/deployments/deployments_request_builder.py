...
class DeploymentsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/deployments{?limit*,offset*}", path_parameters)
    ...
    async def post(self,body: DeployRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[DeployResponse]:
        """
        Create a new deployment (Developer+ required)
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[DeployResponse]
        """
        if body is None:
        ...
        return await self.request_adapter.send_async(request_info, DeployResponse, error_mapping)
    ...
    def to_post_request_information(self,body: DeployRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Create a new deployment (Developer+ required)
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
