...
if TYPE_CHECKING:
    from .service_update_env_vars import ServiceUpdate_env_vars

@dataclass
class ServiceUpdate(AdditionalDataHolder, Parsable):
    ...
    env_vars: Optional[ServiceUpdate_env_vars] = None
    # The image property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ServiceUpdate:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "env_vars": lambda n : setattr(self, 'env_vars', n.get_object_value(ServiceUpdate_env_vars)),
