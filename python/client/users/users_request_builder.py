...
if TYPE_CHECKING:
    ...
    from .item.with_email_item_request_builder import WithEmailItemRequestBuilder
...
class UsersRequestBuilder(BaseRequestBuilder):
    ...
    def by_email(self,email: str) -> WithEmailItemRequestBuilder:
        """
        ...
        url_tpl_params["email"] = email
        return WithEmailItemRequestBuilder(self.request_adapter, url_tpl_params)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[UsersGetResponse]:
        """
        ...
        return await self.request_adapter.send_async(request_info, UsersGetResponse, error_mapping)
